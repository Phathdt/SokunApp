...
public class ListenActivity extends Fragment implements OnClickListener {
    TextView tv_socau, tv_time;
    ImageView imageView;
    int Touch = 0;
    ManageQuestion db;
    ...
    int socau = 5;
    int index = 0;
    Button bt_finish, bt_play, bt_stop;
    Question cauhientai;
    int caudung = 0;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.activity_listen, container, false);

        bt_finish = (Button) view.findViewById(R.id.button1);
        bt_play = (Button) view.findViewById(R.id.button2);
        bt_stop = (Button) view.findViewById(R.id.button3);
        ...
        bt_play.setTypeface(Indam);
        bt_stop.setTypeface(Indam);
        ...
        iv_start.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ds_Question = db.layNcaungaunhien(5);
...
//    }
    ...
    private void Copydatabase() {
        db = new ManageQuestion(getActivity());
        try {
            db.createDataBase();
            db.close();
...
// Kiem tra cau dung
    ...
    public void hienthi(int vitri) {
        cauhientai = ds_Question.get(vitri);
        Bitmap bmImage = BitmapFactory.decodeByteArray(cauhientai.image, 0,cauhientai.image.length);
        imageView.setImageBitmap(bmImage);
        rb_1.setText("đáp án A");
        rb_2.setText("đáp án B");
        rb_3.setText("đáp án C");
        rb_4.setText("đáp án D");


        Uri uri = Uri.parse("android.resource://" + "com.linhnguyen.learningenglish" + "/raw/" + cauhientai.audio);

        sound = MediaPlayer.create(getActivity(), uri);


        if (Finish) // Hien thi cau dung
        {
            System.out.println(cauhientai.dapan);
            System.out.println(db.Laycautraloi(cauhientai));
